...
import mihael.pietri.nasa.dao.NasaRepository
import mihael.pietri.nasa.factory.getNasaRepository
import mihael.pietri.nasa.model.Item

private const val AUTHORITY = "mihael.pietri.nasa.api.provider"
...
class NasaProvider : ContentProvider() {
    ...
    ): Int {when(URI_MATCHER.match(uri)){
